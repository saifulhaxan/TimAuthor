...
export const BrandListing = () => {
  ...
  useEffect(() => {
    document.title = 'Tim Author | Brands Management';
  ...
  const handleSubmit = (event) => {
    ...
    document.querySelector('.loaderBox').classList.remove("d-none");
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/brand-add-edit`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
  ...
  const brandID = (unitID) => {
    document.querySelector('.loaderBox').classList.remove("d-none");
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/view-brand/${unitID}`,
      {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
  ...
  const handleEditSubmit = (event) => {
    ...
    document.querySelector('.loaderBox').classList.remove("d-none");
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/brand-add-edit/${idUser}`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
