...
export const TargetDetails = () => {
    ...
    const editDetailData = () => {
        ...
        document.title = 'Tim Author | Lead Management Detail';
        document.querySelector('.loaderBox').classList.remove("d-none");
        fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/get-unit-targets_details/${id}`,
            {
                method: 'GET',
                headers: {
    ...
    const handleEdit = (event) => {
        ...
        const LogoutData = localStorage.getItem('login');
        fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/unit-targets-edit/${userId}`,
            {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
