...
export const UnitTarget = () => {
  ...
  const fetchData = () => {
    ...
    fetch('https://custom.mystagingserver.site/mtrecords/public/api/author/unit-Target-List',
      {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    document.title = 'Tim Author | Unit Target';
  ...
  const handleSubmit = (event) => {
    ...
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/set-unit-target`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
  ...
  const deleteTarget = async (id) => {
    try {
      const LogoutData = localStorage.getItem('login');
      const response = await fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/unit-targets-delete/${id}`, {
        method: 'DELETE',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
