...
export const UnitListing = () => {
  ...
  const fectchBrandData = () => {
    ...
    fetch('https://custom.mystagingserver.site/mtrecords/public/api/author/brand-listing',
      {
        method: 'GET',
        headers: {
  ...
  const fetchData = () => {
    const LogoutData = localStorage.getItem('login');
    document.querySelector('.loaderBox').classList.remove("d-none");
    fetch('https://custom.mystagingserver.site/mtrecords/public/api/author/unit-listing',
      {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
  ...
  const SelectOptions = [];
  useEffect(() => {
    document.title = 'Tim Author | Units Management';
  ...
  const handleSubmit = (event) => {
    ...
    document.querySelector('.loaderBox').classList.remove("d-none");
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/unit-add-edit`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
  ...
  const editUnit = (unitID) => {
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/view-unit/${unitID}`,
      {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
  ...
  const handleEditSubmit = (event) => {
    ...
    const LogoutData = localStorage.getItem('login');
    fetch(`https://custom.mystagingserver.site/mtrecords/public/api/author/unit-add-edit/${idUser}`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
