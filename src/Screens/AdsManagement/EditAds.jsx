...
export const EditAds = () => {
    ...
    const fetchCategoryData = () => {
        ...
        fetch(`https://custom.mystagingserver.site/Tim-WDLLC/public/api/author/ads_view/${id}`,
            {
                method: 'GET',
                headers: {
    ...
    const handleSubmit = (event) => {
        ...
        fetch(`https://custom.mystagingserver.site/Tim-WDLLC/public/api/author/ads_add_update/${id}`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Authorization': `Bearer ${LogoutData}`
